...
<div class="grid max-w-2xl mx-auto grid-cols-2 p-4 gap-4 mt-4">
    <div class="col-span-2 box p-2 flex items-center justify-between gap-x-2 mb-4">
        ...
        <div class="flex items-center justify-end">
            <button
                class="box py-2 px-3"
                onclick={() => OpenAppDataDir()}>App folder</button
            >
        ...
        <div class="p-2 flex flex-col h-full gap-y-2">
            ...
            {:else}
                ...
                <button
                    class="box"
                    onclick={removeWm}
                    disabled={!isWmInstalled || isWmInstalling || isQuickStarting}>Remove</button
                >
                <button
    ...
    <div class="box flex flex-col">
        ...
        <div class="p-2 flex flex-col gap-y-2">
            ...
            <button
                class="box"
                onclick={removeAmd}
                disabled={!isAmdInstalled || isAmdInstalling || isQuickStarting}>Remove</button
            >
            <button
                class="inline-flex items-center justify-center gap-0.5 text-text-muted"
                onclick={() =>
    ...
    <div class="box p-2 grid grid-cols-2 col-span-2 gap-2 w-full mx-auto my-8 relative">
        <svg
        ...
        <button
            ...
            onclick={quickStart}>{isQuickStarting ? "Working..." : "Quick Start"}</button
        >
    </div>
</div>
